...
@agent_registry.register("misinformation")
class MisinformationAgent(BaseAgent):
    ...
    async def astep_check(self, env_description: str = "", additional_info: str = "") -> Message:
        """Asynchronous version of step"""
        prompt = self.role_description + f" {additional_info}"
