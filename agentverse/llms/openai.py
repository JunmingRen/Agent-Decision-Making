...
try:
    ...
    base_url = None
    model_name = None
    OPENAI_API_KEY = "sk-O5p5bdrLVb2wTE9UhbFApkvK4EjukVL6gW0ZxFtCDrWO4EQk"#os.environ.get("OPENAI_API_KEY")
    OPENAI_BASE_URL = "https://api.pro365.top/v1"#os.environ.get("OPENAI_BASE_URL")
